...
const CustomerRefundNotification = props => {
  ...
  const handleExport = () => {
    var excelParams = {
      ...
      columnKeys: ['paxNumber', 'bagNumber', 'bagStatusPos', 'refundDateTime'],
      allColumns: false,
    }
  ...
  return (
    <div className='container bg-white'>
      <div>
        <h1 className='mb-4 mt-5'>{t('Customer_Refund_Notification_label')}</h1>
      </div>
...
export default connect(null, mapDispatchToProps)(CustomerRefundNotification)
